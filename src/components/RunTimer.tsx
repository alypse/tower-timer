    ...
    <div className="min-h-screen bg-gray-900 text-gray-100 p-8">
      ...
      <div className="controls space-y-6 max-w-3xl mx-auto bg-gray-800 p-6 rounded-xl shadow-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <label className="flex flex-col space-y-2">
            <span className="text-sm font-medium text-gray-300">Intro Sprint Mastery Level:</span>
            <select
              className="bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
          ...
          <label className="flex items-center space-x-3">
          <span className="text-sm font-medium text-gray-300">
            Wave Skip Mastery Enabled:{' '}</span>
            <input
              className="form-checkbox h-5 w-5 text-purple-500 rounded focus:ring-purple-500 focus:ring-offset-gray-800"
              type="checkbox"
          ...
          <label className="flex flex-col space-y-2">
            <span className="text-sm font-medium text-gray-300"> Wave Skip Mastery Level:</span>
            <select
              className="bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
          ...
          <label className="flex flex-col space-y-2">
            <span className="text-sm font-medium text-gray-300">Wave Accelerator Card Level:</span>
            <select
              className="bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
          ...
          <label className="flex items-center space-x-3">
            <span className="text-sm font-medium text-gray-300">Tournament:{' '}</span>
            <input
              className="form-checkbox h-5 w-5 text-purple-500 rounded focus:ring-purple-500 focus:ring-offset-gray-800"
              type="checkbox"
          ...
          <label className="flex items-center space-x-3">
            <span className="text-sm font-medium text-gray-300">Game Speed Perk Wave:</span>
            <input
              className="bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
          ...
          <label className="flex items-center space-x-3">
            <span className="text-sm font-medium text-gray-300">Game Speed Base:</span>
            <input
              className="bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
          ...
          <label className="flex items-center space-x-3">
          <span className="text-sm font-medium text-gray-300"> Game Speed Perk:</span>
            <input
              className="bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
      ...
      <div className="results mt-8 max-w-3xl mx-auto bg-gray-800 p-6 rounded-xl shadow-lg">
        ...
        <div className="result grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-300">
          {Object.entries(runResults).map(([key, value]) => (
            <div key={key} className="flex justify-between p-2 border-b border-gray-700">
